...
class MyFacebookHome extends StatefulWidget {
  final FacebookLogin plugin;

  const MyFacebookHome({Key? key, required this.plugin}) : super(key: key);

  @override
  _MyFacebookHomeState createState() => _MyFacebookHomeState();
}

class _MyFacebookHomeState extends State<MyFacebookHome> {
  String? _sdkVersion;
