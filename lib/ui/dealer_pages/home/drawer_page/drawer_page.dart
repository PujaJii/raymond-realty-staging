...
import '../../forgot_password/update_password.dart';
...
class DrawerPage extends StatelessWidget {
  ...
  final String email;
  final String number;
  const DrawerPage({Key? key, required this.name, required this.email, required this.number})
      : super(key: key);
