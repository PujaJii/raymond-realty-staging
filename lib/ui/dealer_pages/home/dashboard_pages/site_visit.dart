...
import 'package:raymondrealty/ui/dealer_pages/home/dashboard_pages/sm_comment_page.dart';

import '../../../../utils/utils.dart';
import '../../../components/bottom_bar.dart';
import '../../../components/components.dart';

class SiteVisitPage extends StatelessWidget {
            ...
            () => Container(
                ...
                child: Column(
                  children: [
                    ...
                    Row(
                      children: [
                        Text('      Total Walk-Ins : ${AllLeadsController.siteVisitCount.value}',style: TextStyle(fontWeight: FontWeight.bold)),
                      ],
                    ),
                    const SizedBox(height: 10,),
                    Container(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text('${allLeadsController.resForSiteVisit.tenxEraSiteVisit.toString()} Walk-ins'),
                                  ],
                                ),
                              ),
                            ),
                              ...
                              child: Container(
                                ...
                                child:  Column(
                                  ...
                                  children: [
                                    Text('ASPIRATIONAL',
                                        style: TextStyle(fontSize: 16)),
                                    Text('${allLeadsController.resForSiteVisit.aspirationalSiteVisit.toString()} Walk-ins')
                                  ],
                                ),
                              ),
                            ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('PREMIUM',
                                        style: TextStyle(fontSize: 16)),
                                    Text('${allLeadsController.resForSiteVisit.premiumSiteVisit.toString()} Walk-ins')
                                  ],
                                ),
                              ),
                            ),
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text('SUPER PREMIUM',
                                        style: TextStyle(fontSize: 16)),
                                    Text('${allLeadsController.resForSiteVisit.superPrmSiteVisit.toString()} Walk-ins')
                                  ],
                                ),
                              ),
                            ),
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(DateFormat('dd-MMM-yyyy').format(allLeadsController.myFilteredList[index].firstEsvfDate)),
                              Row(
                                mainAxisAlignment:
                                    MainAxisAlignment.spaceAround,
                                children: [
                                  Container(
                                    width: 70,
                                    height: 26,
                                    color: allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.FIRST_VISIT'? AppColors.themeColor: AppColors.cGrayColor,
                                    child: Center(
                                        child: Text(
                                      '1st Visit',
                                      style: TextStyle(fontSize: 10,color: allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.FIRST_VISIT'?Colors.white:Colors.black),
                                    )),
                                  ),
                                  Container(
                                    width: 70,
                                    height: 26,
                                    color:
                                    allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.RE_VISIT_1' ||
                                    allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.RE_VISIT_3'?
                                    AppColors.themeColor: AppColors.cGrayColor,
                                    child: Center(
                                        child: Text(
                                      'Re-Visit',
                                      style: TextStyle(fontSize: 10,
                                          color: allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.RE_VISIT_1' ||
                                              allLeadsController.myFilteredList[index].esvfStatus.toString() == 'EsvfStatus.RE_VISIT_3' ?
                                  ...
                                  InkWell(
                                    onTap: () {
                                      Get.to(()=>SmCommentPage(
                                          name: allLeadsController.myFilteredList[index].customerName.toString(),
                                          project: allLeadsController.myFilteredList[index].project.toString().replaceAll('Project.', ''),
                                          commentText: allLeadsController.myFilteredList[index].smComments.toString(),)
